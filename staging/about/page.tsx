          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mt-4">
                Today, we serve residential clients, businesses, NHS facilities,
                schools, and public buildings across the UK. Every team is
                insured, vetted, and trained to our exacting standards.
              </p>
            </div>
